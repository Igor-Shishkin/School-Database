...
public class GradesTreeNodeMouseListener extends MouseAdapter {
    ...
    private final JLabel informationLabelForPupilPanel;
    private final JPanel pupilsPanel;
    private final JRadioButton getAllPupilsRadioButton;
    ...
    public GradesTreeNodeMouseListener(JTree tree, DefaultMutableTreeNode rootForPupilsTree,
                  List<DefaultMutableTreeNode> nodesForPupilsPanel, DefaultTreeModel pupilsTreeModel,
